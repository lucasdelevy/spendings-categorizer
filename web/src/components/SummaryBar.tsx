...
function Card({
  ...
  return (
    <div className="min-w-0 rounded-lg border border-gray-200 bg-white px-4 py-3 dark:border-gray-700 dark:bg-gray-800">
      <p className="truncate text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400">
        {label}
      </p>
      <p className={`mt-1 truncate text-lg font-semibold tabular-nums ${color} ${color === "text-gray-900" ? "dark:text-gray-100" : ""}`}>
        {value}
      </p>
