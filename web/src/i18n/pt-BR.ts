const ptBR = {
  ...
  categories: {
    ...
    alertThresholdHint:
      "Você receberá um push no iOS quando uma categoria com limite de gasto atingir este percentual. O padrão é 80.",
  ...
  reminders: {
    ...
    back: "Voltar",
    intro:
      "Contas deste mês e dos próximos onze. Qualquer membro marca uma ocorrência como paga. O aviso chega no dia do vencimento, no horário que você escolher.",
    formIntro:
      "Escolha o primeiro vencimento e a repetição. Datas no dia 31 caem no último dia dos meses mais curtos.",
    loading: "Carregando lembretes…",
    empty: "Nenhuma conta à vista — adicione aluguel, contas ou um pagamento único.",
    ...
    deleteConfirm: 'Excluir "{{name}}"? As próximas ocorrências e o histórico serão apagados.',
  ...
  about: {
    ...
    features: {
      ...
      phase22Title: "Recorrência dos lembretes",
      phase22Desc:
        "Cada lembrete tem uma primeira data e se repete uma vez, todo mês ou todo ano. A lista mostra as ocorrências dos próximos meses para marcar aquela data como paga. Criar ou editar fica em uma tela separada da lista.",
    },
  },
